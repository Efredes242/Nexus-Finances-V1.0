...
export interface BudgetEntry {
  ...
  viewType?: 'monthly' | 'biweekly';
  month_year?: string;
  description?: string; // Descripción adicional (ej. "Ezequiel le debe a X")
  partyId?: string; // ID del grupo para gastos compartidos
  isAutoGenerated?: boolean; // Flag para ingresos auto-generados desde gastos compartidos
