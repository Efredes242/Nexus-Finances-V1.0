        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li><button onClick={() => onNavigate('home', 'features')} className="hover:text-blue-400 transition-colors font-medium">Características</button></li>
              <li><button onClick={() => onNavigate('home')} className="hover:text-blue-400 transition-colors font-medium">Seguridad</button></li>
              <li><button onClick={() => onNavigate('home', 'pricing')} className="hover:text-blue-400 transition-colors font-medium">Pricing</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li><button onClick={() => onNavigate('home')} className="hover:text-blue-400 transition-colors font-medium">Sobre nosotros</button></li>
              <li><button onClick={() => onNavigate('home')} className="hover:text-blue-400 transition-colors font-medium">Blog</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm font-medium">
              <li><button onClick={() => onNavigate('privacy')} className="hover:text-blue-400 transition-colors">Privacidad</button></li>
              <li><button onClick={() => onNavigate('terms')} className="hover:text-blue-400 transition-colors">Términos</button></li>
