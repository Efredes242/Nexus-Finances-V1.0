...
const Hero: React.FC<HeroProps> = ({ onScrollToDemo, onScrollToPricing }) => {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight tracking-tighter">
          Potencia <span className="gradient-text">Visual</span> <br className="hidden md:block" />
          para tus Finanzas
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          <button 
            ...
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-500 text-white px-10 py-4 rounded-2xl text-lg font-bold transition-all blue-glow transform hover:scale-105 active:scale-95"
          >
            Empezar Ahora
          </button>
          <button 
